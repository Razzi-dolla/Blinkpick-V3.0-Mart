...
class SocialLoginWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final GoogleSignIn googleSignIn = GoogleSignIn(clientId:'559682777044-9bvqou1fpuk8j30dvfvb1m6v0eeh4830.apps.googleusercontent.com');
  ...
  void _appleLogin() async {
    ...
    //   redirectUri: Uri.parse('https://blinkpick.com/apple'),
    // ),
